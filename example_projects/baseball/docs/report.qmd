...
```{.python include="../../../bibat/template/src/data_preparation.py" start-line=44 end-line=57}
```
...
```{.python include="../../../bibat/template/src/data_preparation.py" start-line=32 end-line=41}
```
